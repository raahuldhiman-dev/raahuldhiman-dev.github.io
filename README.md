...
I'm a **Full-Stack Developer and AI Engineer** based in Mohali, India — founder of [DhimanSoft](https://www.dhimansoft.com), an IT consultancy delivering web apps, AI solutions, and digital products.

**5+ years** shipping production-grade code across PHP, Python, and JavaScript ecosystems. Currently pursuing **MCA in AI & Machine Learning** from Amity University Online while building AI-powered SaaS tools and algorithmic trading systems.

```python
rahul = {
    "location":   "Mohali, Punjab, India 📍",
    "company":    "DhimanSoft (Founder)",
    "focus":      ["AI/ML Systems", "Full-Stack Web", "Algo Trading", "Automation"],
    "currently":  ["AI SaaS platforms", "Trading bot (DTradeX)", "Personal AI Assistant"],
    "open_to":    ["Full-time roles", "Freelance", "AI consulting"],
...
![OpenAI](https://img.shields.io/badge/GPT--4_API-412991?style=for-the-badge&logo=openai&logoColor=white)
...
> **Available for**: Full-time roles · Freelance projects · AI consulting  
> **Location**: Mohali, India — works globally  
